...
import Example from '../app/components/Example.jsx';
...
describe('Example', () => {
  ...
  it('triggers onValueClick()', () => {
    ...
    const component = renderIntoDocument(
      <Example value={value} onValueClick={onValueClick} />
    );
  ...
  it('triggers onEdit', () => {
    ...
    const component = renderIntoDocument(
      <Example editing={true} value={'value'} onEdit={onEdit} />
    );
  ...
  it('allows deletion', () => {
    ...
    const component = renderIntoDocument(
      <Example value={'value'} onDelete={onDelete} />
    );
